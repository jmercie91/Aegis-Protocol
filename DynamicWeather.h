// Aegis Protocol - DynamicWeather.h
// Manages real-time weather effects and applies gameplay changes dynamically.
...
UCLASS()
class AEGISPROTOCOL_API ADynamicWeather : public AActor
{
    GENERATED_BODY()
...
public:
    ...
    // **New Function to Sync Enemy Detection Based on Weather**
    UFUNCTION(BlueprintCallable, Category = "Weather")
    float GetEnemyDetectionModifier() const;
...
private:
    ...
    // **New Function to Adjust Enemy Detection Based on Weather**
    float CalculateEnemyDetectionModifier() const;
};